<section class="content-header">
    <h1>
        Referals
        <small>Input your Referals</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{url('/home')}}"><i class="fa fa-dashboard"></i>Home</a>
        <li><a href="{{url('/referals')}}"><i class="fa fa-user-plus"></i>Referals</a>
...
<section>
    ...
    <section class="content">
            ...
            <div class="box">
              ...
              <div class="box-body">
                {{ Form::open(array('url' => 'referals/create-new', 'class' => 'form-horizontal')) }}
